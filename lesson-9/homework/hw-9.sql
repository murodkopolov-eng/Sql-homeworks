...
FROM Orders o
INNER JOIN Products p ON p.ProductID=o.ProductID WHERE Price>100
...
SELECT p.ProductName,o.OrderID,o.Quantity,p.StockQuantity
FROM Orders o
...
SELECT c.FirstName,c.LastName,c.Country,o.TotalAmount
FROM Orders o
INNER JOIN Customers c ON c.CustomerID=o.CustomerID
